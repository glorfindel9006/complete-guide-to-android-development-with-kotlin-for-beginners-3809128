...
class MainViewModel : ViewModel() {
    ...
    // StateFlow doesnt have interface to modify its value
    // here we link it to the MutableStateFlow which means anything changes will also trigger this StateFlow
